    ...
    pub fn default_font<'a>(&self) -> &'a SegmentedDisplayFont {
        match *self {
            ...
            SegmentedDisplayKind::SixteenSegment => &[
                ...
                0x0100, 0xA070, 0xA0E0, 0x8060, 0xA260, 0xC060, 0xAA02, 0x0000, // 60-67: ` a b c d e f g
                0xA0C0, 0x0040, 0x2220, 0x3A00, 0x00E0, 0xA848, 0xA040, 0xA060, // 68-6F: h i j k l m n o
                0x82C1, 0xA281, 0x8040, 0x0000, 0xAA10, 0x2060, 0x4040, 0x5048, // 70-77: p q r s t u v w
                0x0000, 0x0000, 0xC020, 0xA212, 0x2200, 0x2A21, 0x0A85, 0x0000, // 78-7F: x y z { | } ~ ×
            ],
        }
    }
