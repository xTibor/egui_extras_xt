...
use crate::segmented_display::{
    DisplayFont, DisplayFontGlyph, DisplayKind, SegmentGeometryTransformFn,
};
...
impl SixteenSegment {
    ...
    #[rustfmt::skip]
    pub const GLYPHS_COMPASS: [DisplayFontGlyph; 8] = [
    ...
    #[rustfmt::skip]
    pub const GLYPHS_CLOCK: [DisplayFontGlyph; 64] = [
    ...
    pub const GLYPH_BLUETOOTH: DisplayFontGlyph = 0x6B1E;
    pub const GLYPH_INFRARED: DisplayFontGlyph = 0x3AC6;
}
